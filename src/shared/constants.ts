...
export const MOB_CAMPS: {
  ...
  // Та же сторона карты, что и босс (BOSS.home = (74,74), СВ угол), но в
  // стороне от него — свободное место, вне его дальности агро (38 м).
  { x: 38, z: 50, type: "ruinMage", count: 4, spread: 7 }, // СВ угол, ~140 м, ур.20
];
...
export const PROGRESSION = {
  ...
  int: {
    ...
    resistMul: 0.014, // универсально: доля поглощаемого урона СНАРЯДОВ/магии за очко
    resistCap: 0.4, // потолок магзащиты
