...
export const BOT = {
  ...
  shootRange: 17, // м — с этой дистанции стреляет и ближе не подходит
  shootKeepDist: 9, // м — ближе отходит (как плевун)
  bowCooldown: 1.6, // с
  staffCooldown: 2.2, // с
  /**
   ...
   */
  healRadius: 9, // м вокруг бота — кого достаёт массовый хил
