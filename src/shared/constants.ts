...
export const WORLD = {
  ...
  size: 308, // м, сторона зоны
  playRadius: 205, // м, круглая граница, за которую игрока не пускают (от центра поляны)
  subdivisions: 123, // плотность сетки террейна
  treeCount: 48,
  grassCount: 2000,
...
export const LAKE = {
  ...
  waterY: -1.2,
  /**
   * Ширина прибрежной отмели ЗА пределами radius, где дно поднимается от дна
...
export const MOUNTAIN = {
  ...
  radius: 65,
  /** Высота пика над обычным уровнем земли — заметно больше первой версии. */
  peakHeight: 70,
} as const;
