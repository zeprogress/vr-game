...
export const COMBAT = {
  ...
  vrSwooshSpeed: 5.5, // м/с — только сильный взмах даёт звук
  swooshCooldown: 0.45, // с между звуками взмаха
  dummyHp: 3,
  dummyRespawn: 4, // с
...
export const BOW = {
  ...
  fireThreshold: 0.12, // мин. натяг для выстрела (0..1)
  minSpeed: 15, // м/с при слабом натяге
  maxSpeed: 62, // м/с при полном натяге
