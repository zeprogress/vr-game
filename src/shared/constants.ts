...
export const MOUNTAIN = {
  x: -117,
  // Озеро выросло (95×70м по плану) — гора отодвинута дальше (было -155),
  // иначе её подножие вминалось в увеличенную чашу озера.
  z: -212,
  /** Радиус — тоже вырос вместе с озером/дистанцией, иначе склон слишком крутой у самого берега. */
  radius: 110,
  /** Высота пика — под цель «перепад водопада 42м» (см. terrain.ts CLIFF_RISE) плюс запас на плато. */
  peakHeight: 60,
} as const;
