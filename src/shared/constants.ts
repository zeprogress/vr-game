...
export const PROGRESSION = {
  ...
  str: { hpMul: 0.04, dmgMul: 0.05 }, // +4% HP и +5% урона ближнего боя за очко
  agi: {
    moveMul: 0.018, // +1.8% скорости бега за очко (было 3% — слишком быстро)
    atkSpeedMul: 0.01, // +1% темпа атаки за очко (поверх роста от уровня, потолок ×2.6)
    rangedDmgMul: 0.04, // +4% урона стрелы за очко (чуть слабее, чем сила для меча)
  },
...
export const BOT = {
  ...
  stunCastTime: 1.15, // с замаха: бот заносит удар, вокруг расходится волна
  /** Звук удара играется за столько секунд до самого удара (раньше телеграфа-хлопка). */
  stunSoundLead: 1.0,
  ...
  /**
   * Танк — бот с мечом и щитом. Держит удар за всю группу, поэтому крепче,
   * бьёт сильнее и восстанавливается быстрее и раньше обычного.
   */
  tank: {
    hpMul: 1.6, // × максимум HP
    dmgMul: 1.35, // × урон мечом (и рассекающим ударом)
