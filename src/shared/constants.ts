...
export const BOT = {
   ...
   * Roll 0.917, Jump 1.042 — с небольшим запасом). Сервер на это время
   * тормозит бота (иначе он "едет" под анимацией), клиент — держит клип.
   */
  emoteDuration: { cheer: 1.9, roll: 1, jump: 1.1 } as Record<BotEmote, number>,
  /**
