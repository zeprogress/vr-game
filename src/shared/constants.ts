...
export const BOT = {
   ...
   * Бьёт всех в секторе и отбрасывает их. Как и хил — редкий, с замахом.
   */
  cleaveRange: 6, // м длина конуса
  cleaveCone: 1.0, // рад ПОЛУугла (~57°, сектор ~114°)
  cleaveMinTargets: 2, // «массовый» — от двух мобов в секторе
  cleaveDamageMult: 1.8, // во столько раз сильнее обычного удара
  cleaveKnockback: 11, // м/с отбрасывания
  cleaveStun: 2.5, // с оглушения всех задетых (не двигаются и не бьют)
  cleaveCastTime: 0.7, // с замаха: бот стоит, перед ним горит красный сектор
  cleaveCooldown: 12, // с между рассекающими ударами
  /**
  ...
  stunCastTime: 0.55, // с замаха: бот бьёт землю, вокруг расходится волна
