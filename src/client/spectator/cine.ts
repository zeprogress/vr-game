...
export const CINE_PATHS: CinePath[] = [
  ...
  {
    // Озеро у лагеря на закате: с восточного берега камера скользит вдоль
    // воды, глядя на водопад — тот стоит ровно в стороне заходящего солнца
    // (см. MOUNTAIN в constants.ts), так в кадре и контражурный водопад, и
    // низкое солнце над ним разом.
    name: "Озеро на закате",
    duration: 22,
    lookLevel: 0.3,
    keys: [
      { p: [-77, 8, -108], l: [-117, 6, -158] },
      { p: [-92, 9, -128], l: [-117, 7, -158] },
      { p: [-107, 10, -146], l: [-117, 8, -158] },
      { p: [-97, 9, -133], l: [-117, 7, -158] },
    ],
  },
  {
    // Причал озера: камера у воды со стороны лагеря, смотрит через всё
    // озеро на водопад и гору (Viewpoint C из брифа — лагерь→причал→озеро→водопад).
    name: "Причал озера",
    duration: 18,
    lookLevel: 0.25,
    keys: [
      { p: [-121, 3.4, -74], l: [-117, 5, -158] },
      { p: [-113, 3.6, -76], l: [-117, 6, -158] },
      { p: [-117, 4.2, -71], l: [-117, 6, -158] },
    ],
  },
  {
    // Вид с горы вниз: река → водопад → всё озеро разом (Viewpoint D из брифа).
    name: "Вид с горы",
    duration: 16,
    lookLevel: 0.15,
    freePitch: true,
    keys: [
      { p: [-117, 34, -182], l: [-117, 4, -110] },
      { p: [-110, 30, -175], l: [-117, 4, -108] },
    ],
  },
];
