...
<p><span class="agi">Ловкость (agi)</span> — множитель урона в ближнем и дальнем бою + скорость атаки, ключевой атрибут <span class="cls-archer">лучника</span> (но и мечнику полезна).</p>
...
<p><b>Base</b> — стартовое оружие, всегда доступно. <span class="tier-gold">Gold</span> — золотой тир, множитель урона выше. <span class="tier-legendary">Legendary</span> — именное оружие с механическим эффектом класса (пламенный меч — горение, лук охотника — крит, эгида — усиленный блок, посох бури — сильнее АОЕ).</p>
<p>Поверх тира на <span class="tier-gold">gold</span>/<span class="tier-legendary">legendary</span> дополнительно накатываются 1–3 случайных ролла: <span class="roll">урон</span>, <span class="roll">скорость атаки</span> или <span class="roll">крит</span> — они и делают два меча одного тира разными предметами.</p>

<h2>Лут и дроп</h2>
<p><span class="tier-gold">Золото</span>/<span class="tier-legendary">легендарки</span> может уронить любой моб (обычные — редко, элитные лагеря на карте — заметно чаще), мировой босс — щедрее всех. Трофей <b>25 секунд</b> принадлежит только тому, кто добил моба.</p>
<p>Оружие на земле лежит <b>час</b>, если его не забрали, — потом тает.</p>

<h2>События</h2>
<p><code>!goevent</code> — админ стрима запускает ивент: «нашествие» (толпа мобов, победа даёт шанс на <span class="tier-gold">золото</span>) или «охота на элиту» (именной элитный босс, победа даёт гарантированную <span class="tier-legendary">легендарку</span>).</p>
