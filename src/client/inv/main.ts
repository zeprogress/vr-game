...
<p><b>Base</b> — стартовое оружие, всегда доступно. <span class="tier-gold">Gold</span> — золотой тир, множитель урона выше. <span class="tier-legendary">Legendary</span> — именное оружие с механическим эффектом класса (меч вампира — вампиризм, лук охотника — крит, эгида — усиленный блок, посох бури — сильнее АОЕ).</p>
