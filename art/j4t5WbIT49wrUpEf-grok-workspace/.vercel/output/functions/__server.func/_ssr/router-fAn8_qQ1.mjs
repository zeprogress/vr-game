...
//#region node_modules/.nitro/vite/services/ssr/assets/router-fAn8_qQ1.js
var router_fAn8_qQ1_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CyE0-kUS.css";
var APP_NAME = "Костёр лагеря";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Модель костра боевого лагеря — центр площади хаба."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-C65sI_wc.mjs");
...
//#endregion
export { getRouter, router_fAn8_qQ1_exports as t };
